...
<body>
    <header class="text-gray-600 body-font">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          ...
          <button class="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0"><a href="signup.html">SIGN UP/ENROLL NOW
...
// Update user balance
$sql = "UPDATE entry SET AMOUNT = AMOUNT + $amount WHERE username = '$username'";

if ($conn->query($sql) === TRUE) {
    echo "<h1>Recharge successful.</h>";
} else {
